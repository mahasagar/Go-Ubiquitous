...
//                    .addOnConnectionFailedListener(this)
    ...
    private void notifyWatchForUpdate() {
        Context context = getContext();
        ...
        PutDataMapRequest weatherMapRequest = PutDataMapRequest.create(INFO_PATH);
        DataMap weatherDataMap = weatherMapRequest.getDataMap();
        weatherDataMap.putString(K_HIGH, Utility.formatTemperature(context, cursor.getDouble(INDEX_MAX_TEMP)));
        weatherDataMap.putString(K_LOW, Utility.formatTemperature(context, cursor.getDouble(INDEX_MIN_TEMP)));
        weatherDataMap.putInt(K_WEATHER_CONDITION, cursor.getInt(INDEX_WEATHER_ID));
